package com.github.platform.core.sys.infra.constant;
...
@Getter
@AllArgsConstructor
public enum SysInfraResultEnum implements BaseResult {
    ...
    NOT_FOUND_USER("2310", "未找到对应的账户，请联系管理员添加！"),
    PWD_NOT_EQUALS("2311", "密码不正确,请更正密码重新登录！"),
    USER_DISABLED("2312", "该账户已禁用！，请联系管理员！"),
